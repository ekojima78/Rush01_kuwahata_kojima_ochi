...
/*   Updated: 2025/03/23 16:59:26 by ekojima          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_vertical(int grid[4][4], int constraints[16])
{
	int	i;
...
int	check_horizontal(int grid[4][4], int constraints[16])
{
	int	i;
...
{
	return (check_vertical(grid, constraints) && check_horizontal(grid,
			constraints));
}
